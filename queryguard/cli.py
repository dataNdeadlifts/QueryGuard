...
def run(
    path: Optional[Path] = typer.Argument(default=None, help="Path to a file or folder containing sql queries."),  # noqa: B008 # workaround for defects in typer using optional arguments
    settings: Optional[str] = typer.Option(default="", help="Path to configuration file."),
    select: Optional[str] = typer.Option(default=config.SelectSetting.default, help="Rules to enable."),
    ignore: Optional[str] = typer.Option(default=config.IgnoreSetting.default, help="Rules to ignore."),
    output: Optional[str] = typer.Option(default=config.OutputSetting.default, help="Output format."),
    version: Optional[bool] = typer.Option(default=False, help="Print the version and exit."),
    debug: Optional[bool] = typer.Option(default=config.DebugSetting.default, help="Enable debug logging."),
) -> None:
